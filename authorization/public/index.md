...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>The refresh token issued by the authorization server.</td>
    </tr>
    <tr>
      <td><code>id_token</code></td>
      <td><span class="label label-info">optional</span></td>
      <td>The OpenID Connect identity token (a JSON Web Token) issued by teh authorizaiton server.</td>
    </tr>
    <tr>
...
`application/x-www-form-urlencoded`. Note that for a public client, no
