...
[https://apps-dstu2.smarthealthit.org/growth-chart/launch.html?](https://apps-dstu2.smarthealthit.org/growth-chart/launch.html?fhirServiceUrl=https://sb-fhir-dstu2.smarthealthit.org/api/smartdstu2/open&patientId=SMART-1482713)
...
[https://apps-dstu2.smarthealthit.org/growth-chart/launch.html?](#)
...
```
curl 'https://sb-fhir-dstu2.smarthealthit.org/api/smartdstu2/open/Patient/SMART-1482713' -H 'Accept: application/json'
```
...
```
curl 'https://sb-fhir-dstu2.smarthealthit.org/api/smartdstu2/open/Observation?subject%3APatient=SMART-1482713&code=3141-9%2C8302-2%2C8287-5%2C39156-5&_count=50' -H 'Accept: application/json' 
```
